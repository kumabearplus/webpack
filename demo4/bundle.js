...
// })
  ...
  methods: {
    addTodo: function addTodo() {
      this.todoList.push({
        title: this.newTodo,
        createdAt: (0, _bar2.default)(new Date()),
    ...
    getCurrentUser: function getCurrentUser() {
      ...
      if (current) {
        var _id = current.id,
            _createdAt = current.createdAt,
            _username = current.attributes.username;
        // 上面这句话看不懂就得看 MDN 文档了
        // 我的《ES 6 新特性列表》里面有链接：https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment

        return { id: _id, username: _username, createdAt: _createdAt // 看文档：https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Object_initializer#ECMAScript_6%E6%96%B0%E6%A0%87%E8%AE%B0
        };
      } else {
        return null;
      }
